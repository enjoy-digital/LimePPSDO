...
# IOs ----------------------------------------------------------------------------------------------
io = [
    ("lmk10_clk_out0",   0, Pins("37"), IOStandard("LVCMOS33")),
    ("lmkrf_clk_out4",   0, Pins("35"), IOStandard("LVCMOS33")),
...
class Platform(LatticeiCE40Platform):
    ...
    def do_finalize(self, fragment):
        ...
        self.add_period_constraint(self.lookup_request("lmk10_clk_out0", loose=True), 1e9/10e6)
